...
- [vhost Documentation — docs.kernel.org](https://docs.kernel.org/virt/kvm/index.html)
- [vDPA Documentation — docs.kernel.org](https://docs.kernel.org/networking/device_drivers/ethernet/mellanox/mlx5/index.html)
- [Packed Virtqueues — LWN.net](https://lwn.net/Articles/773778/)
- [virtio-net driver — docs.kernel.org](https://docs.kernel.org/driver-api/virtio/virtio.html)
- [QEMU Virtio Devices](https://www.qemu.org/docs/master/system/devices/virtio/)
