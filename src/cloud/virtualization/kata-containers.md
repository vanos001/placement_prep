...
- [AF_VSOCK: socket address family for VM/host communication (kernel.org)](https://docs.kernel.org/networking/index.html)
- [OpenStack Nova — Kata integration](https://docs.openstack.org/nova/latest/admin/configuration/)
