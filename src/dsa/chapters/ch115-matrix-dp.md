...
M^(10-2) = M^8  (since [T(n), T(n-1), T(n-2)]^T = M^(n-2) · [T(2), T(1), T(0)]^T)

Let's compute step by step:
```
M^1 = [[1,1,1],[1,0,0],[0,1,0]]
M^2 = M·M = [[2,2,1],[1,1,1],[1,0,0]]
M^4 = M^2·M^2 = [[7,6,4],[4,3,2],[2,2,1]]
M^8 = M^4·M^4 = [[81,68,44],[44,37,24],[24,20,13]]
```

Initial vector: [T(2), T(1), T(0)] = [1, 0, 0]

T(10) = M^8[0][0] · 1 + M^8[0][1] · 0 + M^8[0][2] · 0 = 81 ✓
