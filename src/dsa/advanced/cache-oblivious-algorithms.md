...
1. M. Frigo, C. E. Leiserson, H. Prokop, S. Ramachandran, "Cache-Oblivious Algorithms," *40th Annual Symposium on Foundations of Computer Science (FOCS)*, pp. 285-297, 1999, DOI [10.1109/SFFCS.1999.814600](https://doi.org/10.1109/SFFCS.1999.814600) (Crossref-verified; note IEEE registers FOCS '99 under the double-F `SFFCS` prefix — the single-F `SFCS.1999.814600` variant sometimes cited does not resolve, and `10.1109/SFCS.1999.814916` is likewise dead under either prefix). Source of the ideal-cache model, cache-aware/oblivious definitions, REC-MULT/REC-TRANSPOSE/FFT/funnelsort bounds, LRU and multi-level theorems.
