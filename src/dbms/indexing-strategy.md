...
- PostgreSQL Documentation, "[GIN Indexes](https://www.postgresql.org/docs/current/gin.html)" and "[GiST Indexes](https://www.postgresql.org/docs/current/gist.html)" — fastupdate, pending lists, and lossy operators.
