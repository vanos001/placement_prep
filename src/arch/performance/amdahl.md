...
| 90% | 1.82 | 3.08 | 4.71 | 6.40 | 10.0 |
| 95% | 1.90 | 3.48 | 5.93 | 9.14 | 20.0 |
| 99% | 1.98 | 3.88 | 7.48 | 13.91 | 100.0 |
...
```
If P = 0.95:
  8 cores:  Speedup = 1 / (0.05 + 0.95/8)  ≈ 5.93×
  16 cores: Speedup = 1 / (0.05 + 0.95/16) ≈ 9.14×
  32 cores: Speedup = 1 / (0.05 + 0.95/32) ≈ 12.55×
  64 cores: Speedup = 1 / (0.05 + 0.95/64) ≈ 15.42×
