...
**Data:** Company profits (₹Cr) over months:
Jan: 20, Feb: 25, Mar: 30, Apr: 22, May: 35, Jun: 40
...
| Chart Type | Key Skill |
|-----------|-----------|
| Tables | Read exact values, calculate percentages/ratios |
| Bar Charts | Compare heights, read from axis |
| Pie Charts | Convert angles to percentages (÷3.6) |
| Line Graphs | Read trends, calculate slopes |
| Caselets | Extract data, organize, solve |
