...
- [Fabric renderer — reactnative.dev](https://reactnative.dev/architecture/fabric-renderer)
...
- [Performance overview — reactnative.dev](https://reactnative.dev/docs/performance)
