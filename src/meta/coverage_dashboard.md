...
|---------|-------|-------------|----------|----------|
| Operating Systems | 118 | 200+ | 350+ | 75% |
| DBMS | 92 | 180+ | 280+ | 70% |
...
- **Python**: 9 files (CPython internals, GIL, asyncio, typing, data model, packaging, performance)
- **Go**: 5 files (scheduler/GMP, channels, memory model)
- **Java**: 4 files (JVM internals, GC, interview questions)
...
- **Patterns**: Microservices, Event-Driven, Distributed Transactions

### ML Expansion (127 files total)
- **Transformers**: 11 files (attention, architecture, BERT, GPT, T5, ViT, training)
- **LLMs**: 3 files (GPT architecture, training pipeline, scaling laws)

### Other New Content
- Consensus algorithms (Paxos, Raft, ZAB, PBFT)
- Query optimization (cost model, join algorithms)
- Cache coherence (MSI, MESI, MOESI, false sharing)
- TLS deep dive (1.3 handshake, mTLS, certificate transparency)
- Advanced IPC (Unix sockets, D-Bus, POSIX MQ)
- Coding interview patterns (12 patterns)
- Distributed lock manager (Redlock, etcd, fencing tokens)
- Google/Meta interview guides
