...
- Howard, *The Formulae-as-Types Notion of Construction* (1969, published 1980, in *To H.B. Curry: Essays on Combinatory Logic, Lambda Calculus and Formalism*, Academic Press) — the founding paper of the explicit correspondence; the chapter predates DOI registration and has no DOI, so it is cited by venue.
